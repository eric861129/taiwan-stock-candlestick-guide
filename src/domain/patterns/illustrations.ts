...
export const PATTERN_ILLUSTRATIONS: Readonly<Record<PatternCardId, PatternIllustration>> = {
  ...
  'talib-rickshaw-man': illustration('黃包車夫示意', 'Doji 具有雙長影，實體跨過整根 K 棒中點附近。', [candle(80, 52, 52, 13, 91, 'neutral', 'Doji 雙長影'), zone(65, 45, 30, 15, '中點 ±Near'), note(101, 52, '實體跨中點區')]),
  'talib-rise-fall-three-methods': illustration('升降三法示意', '長方向 K、三根反色短 K 反向遞進，再由同色長第五根順勢越界。', [candle(20, 82, 43, 36, 88, 'up', '長一'), candle(48, 37, 48, 31, 54, 'down', '短二'), candle(72, 44, 55, 38, 61, 'down', '短三'), candle(96, 51, 62, 45, 68, 'down', '短四'), candle(130, 64, 22, 16, 70, 'up', '長五')]),
  'talib-separating-lines': illustration('分離線示意', '兩根反色 K 開盤近似，第二根為長實體且起始端影線極短。', [candle(55, 53, 72, 44, 80, 'down', '第一根不限長度'), candle(105, 53, 23, 22, 61, 'up', '第二根長 K'), trend(38, 53, 122, 53, '開盤 Equal'), note(25, 96, '第二根起始影極短')]),
  'talib-short-line': illustration('短線 K 示意', '短實體搭配兩側短影，顏色只描述當根。', [candle(80, 48, 57, 42, 63, 'down', '短實體短影'), note(101, 52, 'BodyShort + ShadowShort')]),
  'talib-spinning-top': illustration('紡錘線示意', '短實體的上、下影線都長於實體本身。', [candle(80, 48, 56, 24, 80, 'down', '短實體雙影'), note(101, 38, '上下影 > 實體')]),
  'talib-stalled-pattern': illustration('停滯型態示意', '三根上漲 K 收盤仍提高，但第三根變短並貼近第二根收盤。', [candle(42, 78, 53, 47, 84, 'up', '長一'), candle(82, 58, 31, 25, 62, 'up', '長二短上影'), candle(120, 37, 27, 21, 43, 'up', '短三貼近'), note(24, 96, '弱化，不等於反轉')]),
  'talib-stick-sandwich': illustration('條形三明治示意', '黑、白、黑三根，第一與第三根收盤近似。', [candle(43, 28, 70, 21, 78, 'down', '黑一'), candle(80, 62, 42, 36, 68, 'up', '白二'), candle(117, 45, 69, 38, 77, 'down', '黑三'), trend(28, 70, 132, 70, '收盤 Equal')]),
  'talib-takuri': illustration('探水竿示意', 'Doji 幾乎沒有上影，並具有超過 ShadowVeryLong 的極長下影。', [candle(80, 26, 26, 24, 93, 'neutral', 'Doji 極長下影'), note(101, 28, '上影極短'), note(101, 85, '下影極長')]),
  'talib-tasuki-gap': illustration('Tasuki 缺口示意', '第一根顏色不限，第二根順向形成實體缺口，第三根反色只回補部分缺口。', [candle(38, 52, 76, 46, 82, 'down', '第一根顏色不限'), candle(78, 40, 22, 16, 46, 'up', '第二根順向'), candle(118, 29, 50, 23, 56, 'down', '第三根反色回補'), zone(48, 46, 82, 10, '保留缺口')]),
  'talib-thrusting': illustration('插入線示意', '長下跌 K 後，上漲 K 開低並收過前收但不超過實體中點。', [candle(55, 23, 76, 17, 84, 'down', '長下跌'), candle(105, 88, 54, 49, 93, 'up', '開低回收'), trend(38, 50, 72, 50, '實體中點'), note(25, 96, '前收 +Equal < close ≤ 中點')]),
  'talib-tristar': illustration('三星十字示意', '三根 Doji 中央一根形成實體跳空，第三根向中央回移才有方向值。', [candle(42, 63, 63, 52, 74, 'neutral', 'Doji 一'), candle(80, 28, 28, 18, 38, 'neutral', '中央 gap'), candle(118, 43, 43, 33, 54, 'neutral', 'Doji 三回移'), note(24, 96, '只有三 Doji 仍可能回 0')]),
  'talib-unique-three-river': illustration('奇特三河示意', '長下跌 K、創低但收高的內包下跌 K，以及短上漲第三根。', [candle(40, 22, 73, 17, 82, 'down', '長黑'), candle(80, 31, 58, 25, 88, 'down', '內包創低'), candle(120, 64, 50, 45, 70, 'up', '短白'), note(24, 96, '第三根開盤 > 第二根 low')]),
  'talib-upside-gap-two-crows': illustration('向上跳空兩烏鴉示意', '長上漲 K 上方的短下跌 K 被第三根下跌實體包住，但第三根仍收在第一根收盤上。', [candle(38, 76, 48, 42, 82, 'up', '長白'), candle(80, 28, 40, 22, 46, 'down', '短黑 gap'), candle(120, 20, 44, 15, 50, 'down', '黑三包覆'), trend(23, 48, 136, 48, '仍高於第一根收盤')]),
  'talib-x-side-gap-three-methods': illustration('跳空三法示意', '前兩根同色並跳空，第三根反色開在第二根實體內、收在第一根實體內。', [candle(38, 78, 58, 51, 84, 'up', '同色一'), candle(80, 40, 22, 16, 46, 'up', '同色二'), candle(120, 29, 66, 23, 72, 'down', '反色跨 gap'), zone(48, 46, 84, 10, '實體 gap')]),
  range: illustration(
    '區間示意',
