...
![人工日 K 線圖以關鍵區域、向下箭頭與文字標籤示範一個缺口。圖例區分可觀察的價格資料與尚待查核的公司公告或制度機制，沒有標示任何後續結果。](../assets/figures/ch17-concept.svg)
...
![台積電 2330 於 2024 年 6 月 3 日至 6 月 13 日的官方原始日線。圖上標示資料區與 6 月 13 日除息機制查核區；圖表終點就是決策日，不含後續走勢。](../assets/figures/ch17-cases.svg)

這是事件脈絡案例，不是報酬案例。若要找公司公告，需回到公開資訊觀測站，以代號、公告日期與類別查詢；不能把 6 月 13 日這個交易日直接當成某則公告的發布日，更不能用決策日以後價格為本案例背書。

## 八步判讀

**八步前置核對。**核對市場、代號、原始價格、決策日、公司行動結果與資料完整性，寫明日 K，並區分交易日、公告發布時間與公司行動生效日。

1. **大方向**：另查整體指數、產業與流動性背景；未查到就列為未知，不讓 K 線代替事件脈絡。
2. **所在位置**：標出關鍵區域、前高前低與事件附近的價格範圍，不把它變成單一神奇線。
3. **量價反應**：只描述已完成 K 線的開、高、低、收與相鄰結構，並把成交量與價格一起記錄；價差、深度與實際可成交數量未查核時不補想像值。
4. **交易情境**：把一般供需、公司行動或公告改變前提的情境分開，保留未查明事件的未知狀態。
5. **觸發條件**：只有市場資料、公告時間與制度限制都支持前提時，才觸發對應行動。
6. **失效條件**：公司行動、公告或制度限制改變前提，或時間資訊無法核實時，原情境失效並需重寫。
7. **風險計算**：把事件時間、制度限制、成本與可成交性造成的風險納入部位判斷；任何一項不明時採不交易。
8. **事後檢討**：保存決策日可見的市場、公告與制度證據，回顧時不把後來發布的資訊倒灌成當時理由。
