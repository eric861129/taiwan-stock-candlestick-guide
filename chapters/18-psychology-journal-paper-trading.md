...
![人工日 K 線圖以失效邊界、箭頭、區域與文字對照先寫規則的決策紀錄，和事後移動停損的流程偏離；沒有宣稱任何一種路徑的後續結果。](../assets/figures/ch18-concept.svg)
...
![台積電 2330 於 2024 年 4 月 1 日至 4 月 30 日的官方原始日線。圖表標出決策前觀察區與決策期的規則紀錄區，終點是 4 月 30 日，不含後續資料。](../assets/figures/ch18-cases.svg)
